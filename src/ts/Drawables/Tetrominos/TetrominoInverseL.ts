...
export class TetrominoInverseL extends _Shape implements IDrawable {
    ...
    override draw() {
        ...
        this.ctx.beginPath()
        this.ctx.fillStyle = this.color
        this.ctx.fillRect(this.position.x - this.width, this.position.y + this.width*2, this.width, this.width)
        this.ctx.closePath()
    }
